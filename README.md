...
## Development environment and release process
 ...
 - create virtualenv with Flask and indecision installed into it (latter is installed in
...
install it (`pip install indecision.tar.gz`), ensure that configuration file exists and
`INDECISION_SETTINGS` environment variable points to it, ensure that user has access to the
